# Udacity-DRL-Continuous_control_DDPG
Code for the second project of the Udacity Deep Reinforcement Learning Nanodegree, Continuous control with ddpg algorithm
...
The algorithm and result are illustrated in Report.md.
